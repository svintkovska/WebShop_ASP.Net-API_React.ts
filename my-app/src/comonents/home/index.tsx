              ...
              <Carousel.Item>
                ...
                <Carousel.Caption>
                  <div className="detail-box">
                    <h1>
                    {t('shop.carousel.welcome')}<br />
                      GIFTOS
                    </h1>
                    <p>
                    {t('shop.carousel.text1')}
                    </p>
                    <Link to="/shop/categories">{t('shop.carousel.startShopping')}</Link>
                  </div>
                </Carousel.Caption>
              </Carousel.Item>
              <Carousel.Item>
              ...
              <div className="col-md-4">
                <div className="box ">
                 ...
                 C281.901,181.576,281.901,176.501,278.771,173.37z"
                  ...
                  <div className="detail-box">
                    <h5>{t('shop.whySection.delivery')}</h5>
                  </div>
                </div>
              </div>
              <div className="col-md-4">
                <div className="box ">
                 ...
                 c5.888,0,10.667-4.779,10.667-10.667S379.221,234.667,373.333,234.667z"
                  ...
                  <div className="detail-box">
                    <h5>{t('shop.whySection.shipping')}</h5>
                 </div>
                </div>
              </div>
              <div className="col-md-4">
                <div className="box ">
                  ...
                  <div className="detail-box">
                  <h5>{t('shop.whySection.quality')}</h5>
                  </div>
                </div>
              </div>
            </div>
