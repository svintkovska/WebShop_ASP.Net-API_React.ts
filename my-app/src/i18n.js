                ...
                translation: {
                    ...
                    shop: {
                        carousel: {
                            ...
                            text1: 'Розкош у красі: Підвищте ефективність свого догляду за шкірою за допомогою нашої преміум-косметики, відкрийте захоплюючі аромати та використовуйте засоби для самого себе. Знайдіть свій стиль у нашому унікальному б\'юті - магазині.',
                            text2: 'Відкрийте світло: Розкрийте чарівність сяючої шкіри, захоплюючих ароматів та скарбів для самогублагополуччя. Від розкішної косметики до захоплюючих парфумів та засобів для самопочуття, наш магазин запрошує вас переглянути свою розкош.',
